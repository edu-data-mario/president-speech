...
from president_speech.db.parquet_interpreter import read_parquet, get_parquet_tmp_path
...
tmp = f'{get_parquet_tmp_path()}/tmp.parquet'
result_df.to_parquet(tmp)
import pandas as panda
result_df = panda.read_parquet(tmp)
